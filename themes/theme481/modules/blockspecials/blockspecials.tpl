...
{if $special}
		<ul>
			<li>
                ...
                <p class="des-main"><a class="product_descr" href="{$special.link}" title="{$special.description_short|escape:html:'UTF-8'|truncate:30:'...'}">{$special.description_short|strip_tags|escape:html:'UTF-8'|truncate:50:'...'}</a></p>                
                <p class="des-mob"><a class="product_descr" href="{$special.link}" title="{$special.description_short|escape:html:'UTF-8'|truncate:30:'...'}">{$special.description_short|strip_tags|escape:html:'UTF-8'|truncate:120:'...'}</a></p>
				<p>
