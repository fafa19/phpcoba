		...
		<form action="#">
			...
			<div class="new_comment_form_content">
				...
				<div id="new_comment_form_footer">
					...
					<p style=" padding-bottom:7px;" class="fl required"><sup>*</sup> {l s='Required fields' mod='productcomments'}</p>
                    	<div class="clearfix"></div>
					<p class="fl">
						<button id="submitNewMessage" class="button" name="submitMessage" type="submit">{l s='Send' mod='productcomments'}</button>&nbsp;&nbsp;&nbsp;
						{l s='or' mod='productcomments'}&nbsp;&nbsp;&nbsp;<a class="button" href="#" onclick="$.fancybox.close();">{l s='Cancel' mod='productcomments'}</a>
					</p>
					<div class="clearfix"></div>
				</div>
			</div>
