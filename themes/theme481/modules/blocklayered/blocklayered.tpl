...
<div id="layered_block_left" class="block">
	...
	<div id="layered_ajax_loader" style="display: none;">
		<p class="lod-main" style="margin:0px!important;  padding:0px!important; border:none!important; position:absolute!important; left:0!important; top:0!important; z-index:9999; width:100%; height:100%; z-index:9999; background:#fff; opacity:0.7;"><img style=" top:30%; left:40%; position:absolute;opacity:1!important;" src="{$img_ps_dir}253.gif" alt="" /></p>
	</div>
</div>
{else}
<div id="layered_block_left" class="block">
