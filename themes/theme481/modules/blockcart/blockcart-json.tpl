...
"id_image": "{$link->getImageLink($product.link_rewrite, $product.id_image, 'small-cart')|addslashes}",
		...
		"name":          "{$product.name|html_entity_decode:2:'UTF-8'|escape:'htmlall'|truncate:25:'...':true}",
