...
$(document).ready(function(){
$("#layered_block_left h4,this").toggle(

function() {
$(this).next('#layered_block_left .block_content,this').slideToggle("slow"),{
duration: 'slow',
easing: 'easeOutBounce'
};

jQuery(this).addClass('mobile-open');
//jQuery('#layered_block_left .block_content').css("border-bottom-color", "#000");
},
function() {
$(this).next('#layered_block_left .block_content,this').slideToggle("slow"),{
duration: 'slow',
