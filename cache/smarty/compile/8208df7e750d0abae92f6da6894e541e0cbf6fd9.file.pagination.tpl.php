<?php /* Smarty version Smarty-3.1.8, created on 2013-12-15 00:03:35
         compiled from "C:\Users\macbookpro\Documents\xampp\htdocs\prestashop123\themes\theme481\pagination.tpl" */ ?>
<?php /*%%SmartyHeaderCode:2282652ac8f677cf221-85260276%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '8208df7e750d0abae92f6da6894e541e0cbf6fd9' => 
    array (
      0 => 'C:\\Users\\macbookpro\\Documents\\xampp\\htdocs\\prestashop123\\themes\\theme481\\pagination.tpl',
      1 => 1363052636,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '2282652ac8f677cf221-85260276',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_52ac8f679918b4_86154495',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_52ac8f679918b4_86154495')) {function content_52ac8f679918b4_86154495($_smarty_tpl) {?><?php if (!is_callable('smarty_modifier_escape')) include 'C:\\Users\\macbookpro\\Documents\\xampp\\htdocs\\prestashop123\\tools\\smarty\\plugins\\modifier.escape.php';
...
"><span></span><?php echo smartyTranslate(array('s'=>'Previous'),$_smarty_tpl);?>
</a></li>
		<?php }else{ ?>
		...
		<?php if ($_smarty_tpl->tpl_vars['start']->value==3){?>
			<li class="pag-top"><a class="bordercolor" <?php echo $_smarty_tpl->tpl_vars['no_follow_text']->value;?>
...
?>
			<?php if ($_smarty_tpl->tpl_vars['p']->value==$_smarty_tpl->getVariable('smarty')->value['section']['pagination']['index']){?>
				<li class="current pag-top"><span><?php echo smarty_modifier_escape($_smarty_tpl->tpl_vars['p']->value, 'htmlall', 'UTF-8');?>
</span></li>
			<?php }else{ ?>
				<li class="pag-top"><a class="bordercolor" <?php echo $_smarty_tpl->tpl_vars['no_follow_text']->value;?>
...
"><?php echo smarty_modifier_escape($_smarty_tpl->getVariable('smarty')->value['section']['pagination']['index'], 'htmlall', 'UTF-8');?>
		...
		<?php if ($_smarty_tpl->tpl_vars['pages_nb']->value>$_smarty_tpl->tpl_vars['stop']->value+2){?>
			<li class="truncate pag-top">...</li>
			<li class="pag-top"><a class="bordercolor" href="<?php echo $_smarty_tpl->tpl_vars['link']->value->goPage($_smarty_tpl->tpl_vars['requestPage']->value,$_smarty_tpl->tpl_vars['pages_nb']->value);?>
...
"><?php echo intval($_smarty_tpl->tpl_vars['pages_nb']->value);?>
		...
		<?php }?>
		<?php if ($_smarty_tpl->tpl_vars['pages_nb']->value==$_smarty_tpl->tpl_vars['stop']->value+2){?>
			<li class="pag-top"><a class="bordercolor" href="<?php echo $_smarty_tpl->tpl_vars['link']->value->goPage($_smarty_tpl->tpl_vars['requestPage']->value,$_smarty_tpl->tpl_vars['pages_nb']->value-1);?>
...
<?php }?>" method="get"  id="pagination_form">
...
" /><?php }?>
						<a class="button_mini" href="javascript:document.getElementById('pagination_form').submit();"><?php echo smartyTranslate(array('s'=>'Ok'),$_smarty_tpl);?>
</a>
