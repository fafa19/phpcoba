<?php /* Smarty version Smarty-3.1.8, created on 2013-12-15 14:17:36
         compiled from "C:\Users\macbookpro\Documents\xampp\htdocs\prestashop123\themes\theme481\shopping-cart.tpl" */ ?>
<?php /*%%SmartyHeaderCode:769852ad5790e92843-18593722%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'f8b30a38fd20c434b7f298e8123104baf9012b6e' => 
    array (
      0 => 'C:\\Users\\macbookpro\\Documents\\xampp\\htdocs\\prestashop123\\themes\\theme481\\shopping-cart.tpl',
      1 => 1363052636,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '769852ad5790e92843-18593722',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_52ad57913b9992_01946335',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_52ad57913b9992_01946335')) {function content_52ad57913b9992_01946335($_smarty_tpl) {?><?php if (!is_callable('smarty_modifier_escape')) include 'C:\\Users\\macbookpro\\Documents\\xampp\\htdocs\\prestashop123\\tools\\smarty\\plugins\\modifier.escape.php';
...
<p class="p-cart"><?php echo smartyTranslate(array('s'=>'Your shopping cart contains:'),$_smarty_tpl);?>
...
?>    <li>
			...
			<?php if (isset($_smarty_tpl->tpl_vars['customizedDatas']->value[$_smarty_tpl->tpl_vars['productId']->value][$_smarty_tpl->tpl_vars['productAttributeId']->value])){?></li>
...
?>
					<li id="product_<?php echo $_smarty_tpl->tpl_vars['product']->value['id_product'];?>
...
_home" alt="" class="customizationUploaded" /></li>
											<?php } ?>
										</ul>
									</div>
		...
		<?php if ($_smarty_tpl->tpl_vars['use_taxes']->value){?>
			<?php if ($_smarty_tpl->tpl_vars['priceDisplay']->value){?>
				<tr class="cart_total_price">
					<td class="tdfirst" colspan="5"><?php if ($_smarty_tpl->tpl_vars['display_tax_label']->value){?><?php echo smartyTranslate(array('s'=>'Total products (tax excl.):'),$_smarty_tpl);?>
...
<?php }?></td>
			...
			<?php }else{ ?>
				<tr class="cart_total_price">
					<td class="tdfirst" colspan="5"><?php if ($_smarty_tpl->tpl_vars['display_tax_label']->value){?><?php echo smartyTranslate(array('s'=>'Total products (tax incl.):'),$_smarty_tpl);?>
<?php }else{ ?><?php echo smartyTranslate(array('s'=>'Total products:'),$_smarty_tpl);?>
<?php }?></td>
		...
		<?php }else{ ?>
			<tr class="cart_total_price">
				<td class="tdfirst" colspan="5"><?php echo smartyTranslate(array('s'=>'Total products:'),$_smarty_tpl);?>
</td>
				<td colspan="2" class="price" id="total_product"><?php echo $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['displayPrice'][0][0]->displayPriceSmarty(array('price'=>$_smarty_tpl->tpl_vars['total_products']->value),$_smarty_tpl);?>
</td>
			</tr>
...
<?php }?>
			...
			<?php if ($_smarty_tpl->tpl_vars['total_shipping_tax_exc']->value<=0&&!isset($_smarty_tpl->tpl_vars['virtualCart']->value)){?>
				<tr class="cart_total_delivery">
					<td class="tdfirst" colspan="5"><?php echo smartyTranslate(array('s'=>'Shipping:'),$_smarty_tpl);?>
</td>
				...
				<?php if ($_smarty_tpl->tpl_vars['use_taxes']->value){?>
					<?php if ($_smarty_tpl->tpl_vars['priceDisplay']->value){?>
						<tr class="cart_total_delivery" <?php if ($_smarty_tpl->tpl_vars['total_shipping_tax_exc']->value<=0){?> style="display:none;"<?php }?>>
							<td class="tdfirst" colspan="5"><?php if ($_smarty_tpl->tpl_vars['display_tax_label']->value){?><?php echo smartyTranslate(array('s'=>'Total shipping (tax excl.):'),$_smarty_tpl);?>
...
<?php }?></td>
					...
					<?php }else{ ?>
						<tr class="cart_total_delivery"<?php if ($_smarty_tpl->tpl_vars['total_shipping']->value<=0){?> style="display:none;"<?php }?>>
							<td class="tdfirst" colspan="5"><?php if ($_smarty_tpl->tpl_vars['display_tax_label']->value){?><?php echo smartyTranslate(array('s'=>'Total shipping (tax incl.):'),$_smarty_tpl);?>
<?php }else{ ?><?php echo smartyTranslate(array('s'=>'Total shipping:'),$_smarty_tpl);?>
<?php }?></td>
				...
				<?php }else{ ?>
					<tr class="cart_total_delivery"<?php if ($_smarty_tpl->tpl_vars['total_shipping_tax_exc']->value<=0){?> style="display:none;"<?php }?>>
						<td class="tdfirst" colspan="5"><?php echo smartyTranslate(array('s'=>'Total shipping:'),$_smarty_tpl);?>
</td>
						<td colspan="2" class="price" id="total_shipping" ><?php echo $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['displayPrice'][0][0]->displayPriceSmarty(array('price'=>$_smarty_tpl->tpl_vars['total_shipping_tax_exc']->value),$_smarty_tpl);?>
</td>
					</tr>
			...
			<tr  class="cart_total_price">
				<td class="tdfirst" colspan="5"><?php echo smartyTranslate(array('s'=>'Total (tax excl.):'),$_smarty_tpl);?>
</td>
			...
			<tr class="cart_total_tax">
				<td class="tdfirst" colspan="5"><?php echo smartyTranslate(array('s'=>'Total tax:'),$_smarty_tpl);?>
</td>
			...
			<tr class="cart_total_price">
				...
				<?php if ($_smarty_tpl->tpl_vars['use_taxes']->value){?>
					...
					<td class="tdfirst" colspan="5"><?php echo smartyTranslate(array('s'=>'Total:'),$_smarty_tpl);?>
</td>
			        <td class="price" id="total_price"><span class="price"> <?php echo $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['displayPrice'][0][0]->displayPriceSmarty(array('price'=>$_smarty_tpl->tpl_vars['total_price']->value),$_smarty_tpl);?>
</span></td>
				...
				<?php }else{ ?>
					...
					<td class="price" id="total_price"><span class="price"> <?php echo $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['displayPrice'][0][0]->displayPriceSmarty(array('price'=>$_smarty_tpl->tpl_vars['total_price_without_tax']->value),$_smarty_tpl);?>
</span></td>
...
">
				<td class="cart_discount_name" colspan="3"><span style=""><?php echo $_smarty_tpl->tpl_vars['discount']->value['name'];?>
</span></td>
...
<?php }?>
				...
				<td class="cart_discount_price">
					<span style=" margin-right:10px;" class="price-discount price"><?php if (!$_smarty_tpl->tpl_vars['priceDisplay']->value){?><?php echo $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['displayPrice'][0][0]->displayPriceSmarty(array('price'=>$_smarty_tpl->tpl_vars['discount']->value['value_real']*-1),$_smarty_tpl);?>
<?php }else{ ?><?php echo $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['displayPrice'][0][0]->displayPriceSmarty(array('price'=>$_smarty_tpl->tpl_vars['discount']->value['value_tax_exc']*-1),$_smarty_tpl);?>
<?php }?></span>
				</td>
...
" class="price_discount_delete button" title="<?php echo smartyTranslate(array('s'=>'Delete'),$_smarty_tpl);?>
...
<?php }?>" method="post" id="voucher">
				<fieldset >
							<h2><label for="discount_name"><?php echo smartyTranslate(array('s'=>'Vouchers'),$_smarty_tpl);?>
</label></h2>
							<p>
...
?>
			<ul class="bordercolor address <?php if ($_smarty_tpl->tpl_vars['address']->last){?>last_item<?php }elseif($_smarty_tpl->tpl_vars['address']->first){?>first_item<?php }?> <?php if ($_smarty_tpl->tpl_vars['address']->index%2){?>alternate_item<?php }else{ ?>item<?php }?>">
