<?php /* Smarty version Smarty-3.1.8, created on 2013-12-18 01:46:20
         compiled from "C:\Users\macbookpro\Documents\xampp\htdocs\prestashop123\themes\theme481\order-detail.tpl" */ ?>
<?php /*%%SmartyHeaderCode:1465552b09bfd013606-41259586%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '5426c51f7185435d84e27a903892ac5bf9c27c8b' => 
    array (
      0 => 'C:\\Users\\macbookpro\\Documents\\xampp\\htdocs\\prestashop123\\themes\\theme481\\order-detail.tpl',
      1 => 1363052636,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '1465552b09bfd013606-41259586',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_52b09bfd5c0271_43841052',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_52b09bfd5c0271_43841052')) {function content_52b09bfd5c0271_43841052($_smarty_tpl) {?><?php if (!is_callable('smarty_modifier_escape')) include 'C:\\Users\\macbookpro\\Documents\\xampp\\htdocs\\prestashop123\\tools\\smarty\\plugins\\modifier.escape.php';
...
" name="id_order"/>
		<h4>
			<input style="margin-bottom:20px;" type="submit" value="<?php echo smartyTranslate(array('s'=>'Reorder'),$_smarty_tpl);?>
...
<?php if ($_smarty_tpl->tpl_vars['order']->value->gift){?>
	<p><img src="<?php echo $_smarty_tpl->tpl_vars['img_dir']->value;?>
icon/gift.png" alt="" class="icon" />&nbsp;<?php echo smartyTranslate(array('s'=>'You requested gift-wrapping for your order.'),$_smarty_tpl);?>
</p>
...
<div id="order-detail-content" class="table_block">
 ...
 if (jQuery('.container_24').width() < 450) {
  jQuery('#order-detail-content-table .td-1').prepend('<strong>Reference:</strong>');
  jQuery('#order-detail-content-table .td-2').prepend('<strong>Product:</strong>');
  jQuery('#order-detail-content-table .td-3').prepend('<strong>Quantity:</strong>');
  jQuery('#order-detail-content-table .td-4').prepend('<strong>Unit pricet:</strong>');
  jQuery('#order-detail-content-table .td-5').prepend('<strong>Total price:</strong>');
 }
...
<?php }?>:</strong> <span class="price"><?php echo $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['displayWtPriceWithCurrency'][0][0]->displayWtPriceWithCurrency(array('price'=>$_smarty_tpl->tpl_vars['order']->value->getTotalProductsWithTaxes(),'currency'=>$_smarty_tpl->tpl_vars['currency']->value),$_smarty_tpl);?>
			...
			<tr class="item">
				<td  colspan="<?php if ($_smarty_tpl->tpl_vars['return_allowed']->value||$_smarty_tpl->tpl_vars['order']->value->hasProductReturned()){?><?php if ($_smarty_tpl->tpl_vars['order']->value->hasProductReturned()&&$_smarty_tpl->tpl_vars['return_allowed']->value){?>7<?php }else{ ?>6<?php }?><?php }else{ ?>5<?php }?>">
					<strong><?php echo smartyTranslate(array('s'=>'Total gift-wrapping:'),$_smarty_tpl);?>
			...
			<?php if (!isset($_smarty_tpl->tpl_vars['product']->value['deleted'])){?>
				...
				<?php if (isset($_smarty_tpl->tpl_vars['product']->value['customizedDatas'])){?>
					<tr class="item">
						...
						<td class="td-1"><label for="cb_<?php echo intval($_smarty_tpl->tpl_vars['product']->value['id_order_detail']);?>
...
"><?php echo smarty_modifier_escape($_smarty_tpl->tpl_vars['product']->value['product_name'], 'htmlall', 'UTF-8');?>
						...
						<td class="td-3"><input class="order_qte_input"  name="order_qte_input[<?php echo $_smarty_tpl->getVariable('smarty')->value['foreach']['products']['index'];?>
...
<?php $_tmp2=ob_get_clean();?><?php echo $_smarty_tpl->tpl_vars['link']->value->getPageLink('get-file',true,null,"key=".$_tmp1."-".$_tmp2."&amp;id_order=".($_smarty_tpl->tpl_vars['order']->value->id)."&secure_key=".($_smarty_tpl->tpl_vars['order']->value->secure_key));?>
...
<?php $_tmp6=ob_get_clean();?><?php echo $_smarty_tpl->tpl_vars['link']->value->getPageLink('get-file',true,null,"key=".$_tmp5."-".$_tmp6."&id_order=".($_smarty_tpl->tpl_vars['order']->value->id)."&secure_key=".($_smarty_tpl->tpl_vars['order']->value->secure_key));?>
" title="<?php echo smartyTranslate(array('s'=>'download this product'),$_smarty_tpl);?>
"> <?php echo smarty_modifier_escape($_smarty_tpl->tpl_vars['product']->value['product_name'], 'htmlall', 'UTF-8');?>
 	</a>
									<?php }else{ ?>
...
"> <?php echo smarty_modifier_escape($_smarty_tpl->tpl_vars['product']->value['product_name'], 'htmlall', 'UTF-8');?>
						...
						<td class="td-3"><input class="order_qte_input" name="order_qte_input[<?php echo intval($_smarty_tpl->tpl_vars['product']->value['id_order_detail']);?>
...
<div class="table_block">
 ...
 if (jQuery('.container_24').width() < 450) {
  jQuery('#shipping-table .tds-1').prepend('<strong>Date:</strong>');
  jQuery('#shipping-table .tds-2').prepend('<strong>Carrier:</strong>');
  jQuery('#shipping-table .tds-3').prepend('<strong>Weight:</strong>');
  jQuery('#shipping-table .tds-4').prepend('<strong>Shipping cost:</strong>');
  jQuery('#shipping-table .tds-5').prepend('<strong>Tracking number:</strong>');
 }

});
                    </script>
<?php if (count($_smarty_tpl->tpl_vars['order']->value->getShipping())>0){?>
	<table id="shipping-table" class="std">
		<thead>
			<tr>
				<th class="first_item"><?php echo smartyTranslate(array('s'=>'Date'),$_smarty_tpl);?>
</th>
...
?>
			<tr class="item">
				<td class="tds-1"><?php echo $_smarty_tpl->tpl_vars['line']->value['date_add'];?>
</td>
				<td class="tds-2"><?php echo $_smarty_tpl->tpl_vars['line']->value['state_name'];?>
</td>
				<td class="tds-3"><?php if ($_smarty_tpl->tpl_vars['line']->value['weight']>0){?><?php echo sprintf("%.3f",$_smarty_tpl->tpl_vars['line']->value['weight']);?>
 <?php echo Configuration::get('PS_WEIGHT_UNIT');?>
<?php }else{ ?>-<?php }?></td>
				<td class="tds-4"><?php if ($_smarty_tpl->tpl_vars['order']->value->getTaxCalculationMethod()==@PS_TAX_INC){?><?php echo $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['displayPrice'][0][0]->displayPriceSmarty(array('price'=>$_smarty_tpl->tpl_vars['line']->value['shipping_cost_tax_incl'],'currency'=>$_smarty_tpl->tpl_vars['currency']->value->id),$_smarty_tpl);?>
...
<?php }else{ ?>
<p><img src="<?php echo $_smarty_tpl->tpl_vars['img_dir']->value;?>
icon/infos.png" alt="" class="icon" />&nbsp;<?php echo smartyTranslate(array('s'=>'You cannot make a merchandise return with a guest account'),$_smarty_tpl);?>
</p>
<?php }?>
<?php }} ?>