<?php /* Smarty version Smarty-3.1.8, created on 2013-12-14 23:35:59
         compiled from "C:\Users\macbookpro\Documents\xampp\htdocs\prestashop123\admin123/themes/default\template\controllers\products\informations.tpl" */ ?>
<?php /*%%SmartyHeaderCode:587252ac88ef1d60f2-90264855%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '845a70bbe9b646b2d80712f9109105a9fd4744d1' => 
    array (
      0 => 'C:\\Users\\macbookpro\\Documents\\xampp\\htdocs\\prestashop123\\admin123/themes/default\\template\\controllers\\products\\informations.tpl',
      1 => 1347546544,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '587252ac88ef1d60f2-90264855',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_52ac88ef623247_41089448',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_52ac88ef623247_41089448')) {function content_52ac88ef623247_41089448($_smarty_tpl) {?><?php if (!is_callable('smarty_modifier_escape')) include 'C:\\Users\\macbookpro\\Documents\\xampp\\htdocs\\prestashop123\\tools\\smarty\\plugins\\modifier.escape.php';
?>
...
" style="width: 130px; margin-right: 5px;" /> <span class="small"><?php echo smartyTranslate(array('s'=>'(US, Canada)'),$_smarty_tpl);?>
	...
	<tr>
		...
		<td style="padding-bottom:5px;">
			<ul class="listForm">
				<li>
					<input onclick="toggleDraftWarning(false);showOptions(true);" type="radio" name="active" id="active_on" value="1" <?php if ($_smarty_tpl->tpl_vars['product']->value->active||!$_smarty_tpl->tpl_vars['product']->value->isAssociatedToShop()){?>checked="checked" <?php }?> />
					<label for="active_on" class="radioCheck"><?php echo smartyTranslate(array('s'=>'Enabled'),$_smarty_tpl);?>
</label>
				</li>
				<li>
					<input onclick="toggleDraftWarning(true);showOptions(false);"  type="radio" name="active" id="active_off" value="0" <?php if (!$_smarty_tpl->tpl_vars['product']->value->active&&$_smarty_tpl->tpl_vars['product']->value->isAssociatedToShop()){?>checked="checked"<?php }?> />
