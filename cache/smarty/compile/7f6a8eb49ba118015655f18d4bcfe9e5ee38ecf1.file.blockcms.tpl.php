<?php /* Smarty version Smarty-3.1.8, created on 2013-12-14 23:33:43
         compiled from "C:\Users\macbookpro\Documents\xampp\htdocs\prestashop123\themes\theme481\modules\blockcms\blockcms.tpl" */ ?>
<?php /*%%SmartyHeaderCode:2048052ac88672fc9a1-33755687%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '7f6a8eb49ba118015655f18d4bcfe9e5ee38ecf1' => 
    array (
      0 => 'C:\\Users\\macbookpro\\Documents\\xampp\\htdocs\\prestashop123\\themes\\theme481\\modules\\blockcms\\blockcms.tpl',
      1 => 1363052636,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '2048052ac88672fc9a1-33755687',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_52ac88673c8958_70384575',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_52ac88673c8958_70384575')) {function content_52ac88673c8958_70384575($_smarty_tpl) {?><?php if (!is_callable('smarty_modifier_escape')) include 'C:\\Users\\macbookpro\\Documents\\xampp\\htdocs\\prestashop123\\tools\\smarty\\plugins\\modifier.escape.php';
...
<?php }else{ ?>
	...
	<div id="tmfooterlinks">
		...
		<div><h4><?php echo smartyTranslate(array('s'=>'Information','mod'=>'blockcms'),$_smarty_tpl);?>
</h4>
        <ul>
...
"><?php echo smarty_modifier_escape($_smarty_tpl->tpl_vars['cmslink']->value['meta_title'], 'htmlall', 'UTF-8');?>
			...
			<?php } ?>
        		...
        		<div><h4><?php echo smartyTranslate(array('s'=>'Our offers','mod'=>'blockcms'),$_smarty_tpl);?>
</h4>
        <ul>
...
"><?php echo smartyTranslate(array('s'=>'Top sellers','mod'=>'blockcms'),$_smarty_tpl);?>
	...
	<?php if (!$_smarty_tpl->tpl_vars['PS_CATALOG_MODE']->value){?><li class="item"><a href="<?php echo $_smarty_tpl->tpl_vars['link']->value->getPageLink('manufacturer');?>
" title="<?php echo smartyTranslate(array('s'=>'Manufacturers','mod'=>'blockcms'),$_smarty_tpl);?>
"><?php echo smartyTranslate(array('s'=>'Manufacturers','mod'=>'blockcms'),$_smarty_tpl);?>
</a></li><?php }?>
    <?php if (!$_smarty_tpl->tpl_vars['PS_CATALOG_MODE']->value){?><li class="item"><a href="<?php echo $_smarty_tpl->tpl_vars['link']->value->getPageLink('supplier');?>
" title="<?php echo smartyTranslate(array('s'=>'Suppliers','mod'=>'blockcms'),$_smarty_tpl);?>
"><?php echo smartyTranslate(array('s'=>'Suppliers','mod'=>'blockcms'),$_smarty_tpl);?>
</a></li><?php }?>
    <?php if (!$_smarty_tpl->tpl_vars['PS_CATALOG_MODE']->value){?><li class="item"><a href="<?php echo $_smarty_tpl->tpl_vars['link']->value->getPageLink('sitemap');?>
