<?php /* Smarty version Smarty-3.1.8, created on 2013-12-15 14:17:58
         compiled from "C:\Users\macbookpro\Documents\xampp\htdocs\prestashop123\themes\theme481\addresses.tpl" */ ?>
<?php /*%%SmartyHeaderCode:2223952ad57a6a21812-74866663%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'f31856fd99baed771559611abc2732b9a39952b6' => 
    array (
      0 => 'C:\\Users\\macbookpro\\Documents\\xampp\\htdocs\\prestashop123\\themes\\theme481\\addresses.tpl',
      1 => 1363052636,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '2223952ad57a6a21812-74866663',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_52ad57a6b8fa10_66929045',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_52ad57a6b8fa10_66929045')) {function content_52ad57a6b8fa10_66929045($_smarty_tpl) {?><?php if (!is_callable('smarty_function_counter')) include 'C:\\Users\\macbookpro\\Documents\\xampp\\htdocs\\prestashop123\\tools\\smarty\\plugins\\function.counter.php';
...
?>
		<ul class="address bordercolor <?php if ($_smarty_tpl->getVariable('smarty')->value['foreach']['myLoop']['last']){?>last_item<?php }elseif($_smarty_tpl->getVariable('smarty')->value['foreach']['myLoop']['first']){?>first_item<?php }?> <?php if ($_smarty_tpl->getVariable('smarty')->value['foreach']['myLoop']['index']%2){?>alternate_item<?php }else{ ?>item<?php }?>">
...
"<?php }?>>
			...
			<?php } ?>
			<li class="address_update"><a class="" href="<?php ob_start();?><?php echo intval($_smarty_tpl->tpl_vars['address']->value['object']['id']);?>
...
"><?php echo smartyTranslate(array('s'=>'Update'),$_smarty_tpl);?>
			...
			<li class="address_delete"><a class="" href="<?php ob_start();?><?php echo intval($_smarty_tpl->tpl_vars['address']->value['object']['id']);?>
...
<div class="address_add"><a href="<?php echo $_smarty_tpl->tpl_vars['link']->value->getPageLink('address',true);?>
...
icon/my-account.png" alt="" class="icon" /> <?php echo smartyTranslate(array('s'=>'Back to your account'),$_smarty_tpl);?>
</a></li>
	<li class="f_right"><a href="<?php echo $_smarty_tpl->tpl_vars['base_dir']->value;?>
"><img src="<?php echo $_smarty_tpl->tpl_vars['img_dir']->value;?>
icon/home.png" alt="" class="icon" /> <?php echo smartyTranslate(array('s'=>'Home'),$_smarty_tpl);?>
</a></li>
</ul><?php }} ?>