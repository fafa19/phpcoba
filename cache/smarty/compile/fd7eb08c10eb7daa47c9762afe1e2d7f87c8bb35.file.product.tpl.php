<?php /* Smarty version Smarty-3.1.8, created on 2013-12-14 23:58:40
         compiled from "C:\Users\macbookpro\Documents\xampp\htdocs\prestashop123\themes\theme481\product.tpl" */ ?>
<?php /*%%SmartyHeaderCode:676152ac8e40c73318-15345559%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'fd7eb08c10eb7daa47c9762afe1e2d7f87c8bb35' => 
    array (
      0 => 'C:\\Users\\macbookpro\\Documents\\xampp\\htdocs\\prestashop123\\themes\\theme481\\product.tpl',
      1 => 1363052636,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '676152ac8e40c73318-15345559',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_52ac8e415482f0_41911547',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_52ac8e415482f0_41911547')) {function content_52ac8e415482f0_41911547($_smarty_tpl) {?><?php if (!is_callable('smarty_modifier_escape')) include 'C:\\Users\\macbookpro\\Documents\\xampp\\htdocs\\prestashop123\\tools\\smarty\\plugins\\modifier.escape.php';
...
if (!is_callable('smarty_function_counter')) include 'C:\\Users\\macbookpro\\Documents\\xampp\\htdocs\\prestashop123\\tools\\smarty\\plugins\\function.counter.php';
...
<?php if ($_smarty_tpl->tpl_vars['jqZoomEnabled']->value){?><a id="zoom1" rel="position: 'inside' , showTitle: false, adjustX:0, adjustY:0" class="cloud-zoom" href="<?php echo $_smarty_tpl->tpl_vars['link']->value->getImageLink($_smarty_tpl->tpl_vars['product']->value->link_rewrite,$_smarty_tpl->tpl_vars['cover']->value['id_image'],'thickbox');?>
" style="position: relative; display: block; width:106px!important; height:106px!important;">


<img alt="<?php echo smarty_modifier_escape($_smarty_tpl->tpl_vars['product']->value->name, 'htmlall', 'UTF-8');?>
" width="106" height="106"  title="<?php echo smarty_modifier_escape($_smarty_tpl->tpl_vars['product']->value->name, 'htmlall', 'UTF-8');?>
" src="<?php echo $_smarty_tpl->tpl_vars['link']->value->getImageLink($_smarty_tpl->tpl_vars['product']->value->link_rewrite,$_smarty_tpl->tpl_vars['cover']->value['id_image'],'large');?>
" style="display: block ; z-index:2; opacity:0; width:106px!important; height:106px!important;">

<img alt="<?php echo smarty_modifier_escape($_smarty_tpl->tpl_vars['product']->value->name, 'htmlall', 'UTF-8');?>
"  id="bigpic" class="picpic" width="304" height="388" title="<?php echo smarty_modifier_escape($_smarty_tpl->tpl_vars['product']->value->name, 'htmlall', 'UTF-8');?>
" src="<?php echo $_smarty_tpl->tpl_vars['link']->value->getImageLink($_smarty_tpl->tpl_vars['product']->value->link_rewrite,$_smarty_tpl->tpl_vars['cover']->value['id_image'],'large');?>
" style="display: block; margin-top:0px; margin-left:0; top:-270px; left:-186px; position:absolute; z-index:1">
...
-default-large.jpg" alt="" id="bigpic" title="<?php echo smarty_modifier_escape($_smarty_tpl->tpl_vars['product']->value->name, 'htmlall', 'UTF-8');?>
" />
<?php }?>
</div> 
...
?>
                                ...
                                <div id='item'>
                                     <?php if ($_smarty_tpl->tpl_vars['jqZoomEnabled']->value){?>
                                       <a href="<?php echo $_smarty_tpl->tpl_vars['link']->value->getImageLink($_smarty_tpl->tpl_vars['product']->value->link_rewrite,$_smarty_tpl->tpl_vars['imageIds']->value,'zoom');?>
" class="cloud-zoom-gallery" title="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['image']->value['legend']);?>
" rel="useZoom: 'zoom1', smallImage: '<?php echo $_smarty_tpl->tpl_vars['link']->value->getImageLink($_smarty_tpl->tpl_vars['product']->value->link_rewrite,$_smarty_tpl->tpl_vars['imageIds']->value,'large');?>
'">
                                            <img src="<?php echo $_smarty_tpl->tpl_vars['link']->value->getImageLink($_smarty_tpl->tpl_vars['product']->value->link_rewrite,$_smarty_tpl->tpl_vars['imageIds']->value,'larg-mini');?>
...
" src="<?php echo $_smarty_tpl->tpl_vars['link']->value->getImageLink($_smarty_tpl->tpl_vars['product']->value->link_rewrite,$_smarty_tpl->tpl_vars['imageIds']->value,'larg-mini');?>
" alt="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['image']->value['legend']);?>
"  />
						</a>
                                    <?php }?> 
		  ...
		  <?php if (isset($_smarty_tpl->tpl_vars['images']->value)&&count($_smarty_tpl->tpl_vars['images']->value)>3){?>	<div class = 'next2'></div><?php }?>
		  <?php if (isset($_smarty_tpl->tpl_vars['images']->value)&&count($_smarty_tpl->tpl_vars['images']->value)>3){?>	<div class = 'prev2 unselectable2'></div><?php }?>
	...
	<div id="pb-left-column">
		...
		<div id="short_description_block">
			<?php if ($_smarty_tpl->tpl_vars['product']->value->description_short){?>
				<div id="short_description_content" class="rte align_justify"><?php echo $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_MODIFIER]['truncate'][0][0]->smarty_modifier_truncate(strip_tags($_smarty_tpl->tpl_vars['product']->value->description_short),170,'...');?>
</div>
			<?php }?>
			  </div>
		<?php }?>
			<p id="product_reference" <?php if (isset($_smarty_tpl->tpl_vars['groups']->value)||!$_smarty_tpl->tpl_vars['product']->value->reference){?>style="display: none;"<?php }?>>
				<label for="product_reference"><b><?php echo smartyTranslate(array('s'=>'Reference:'),$_smarty_tpl);?>
</b> </label>
				<span style=" font-weight:bold" class="editable"><?php echo smarty_modifier_escape($_smarty_tpl->tpl_vars['product']->value->reference, 'htmlall', 'UTF-8');?>
</span>
			</p>
...
<div class="more_info_inner">
		<?php if ($_smarty_tpl->tpl_vars['product']->value->description){?><h3><?php echo smartyTranslate(array('s'=>'More info'),$_smarty_tpl);?>
</h3><?php }?>
...
<div class="more_info_inner2">
	...
	<?php if ($_smarty_tpl->tpl_vars['features']->value){?><h3><?php echo smartyTranslate(array('s'=>'Data sheet'),$_smarty_tpl);?>
</h3><?php }?>
...
<div class="more_info_inner3">
		<?php if ($_smarty_tpl->tpl_vars['attachments']->value){?><h3><?php echo smartyTranslate(array('s'=>'Download'),$_smarty_tpl);?>
</h3><?php }?>
...
<div class="more_info_inner4">
	<?php if (isset($_smarty_tpl->tpl_vars['accessories']->value)&&$_smarty_tpl->tpl_vars['accessories']->value){?><h3><?php echo smartyTranslate(array('s'=>'Accessories'),$_smarty_tpl);?>
</a></h3><?php }?>
...
" class="accessory_image product_img_link bordercolor"><img src="<?php echo $_smarty_tpl->tpl_vars['link']->value->getImageLink($_smarty_tpl->tpl_vars['accessory']->value['link_rewrite'],$_smarty_tpl->tpl_vars['accessory']->value['id_image'],'medium');?>
...
"><?php echo smarty_modifier_escape($_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_MODIFIER]['truncate'][0][0]->smarty_modifier_truncate($_smarty_tpl->tpl_vars['accessory']->value['name'],22,'...',true), 'htmlall', 'UTF-8');?>
                                           ...
                                           <a class="product_desc" href="<?php echo smarty_modifier_escape($_smarty_tpl->tpl_vars['accessoryLink']->value, 'htmlall', 'UTF-8');?>
" title="<?php echo smartyTranslate(array('s'=>'More'),$_smarty_tpl);?>
" class="product_description"><?php echo $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_MODIFIER]['truncate'][0][0]->smarty_modifier_truncate(preg_replace('!<[^>]*?>!', ' ', $_smarty_tpl->tpl_vars['accessory']->value['description_short']),170,'...');?>
</a>
                                           
                                             <a class="product_desc mob" href="<?php echo smarty_modifier_escape($_smarty_tpl->tpl_vars['accessoryLink']->value, 'htmlall', 'UTF-8');?>
" title="<?php echo smartyTranslate(array('s'=>'More'),$_smarty_tpl);?>
" class="product_description"><?php echo $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_MODIFIER]['truncate'][0][0]->smarty_modifier_truncate(preg_replace('!<[^>]*?>!', ' ', $_smarty_tpl->tpl_vars['accessory']->value['description_short']),70,'...');?>
</a>
...
" class="customization_delete_icon" width="9" height="9" />
										</a>
									</div>
									<?php }?>
									<div class="customizationUploadBrowse">
