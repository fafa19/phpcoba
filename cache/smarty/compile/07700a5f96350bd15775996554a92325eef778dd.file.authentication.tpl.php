<?php /* Smarty version Smarty-3.1.8, created on 2013-12-15 14:16:22
         compiled from "C:\Users\macbookpro\Documents\xampp\htdocs\prestashop123\themes\theme481\authentication.tpl" */ ?>
<?php /*%%SmartyHeaderCode:1706252ad57461d33d1-50858817%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '07700a5f96350bd15775996554a92325eef778dd' => 
    array (
      0 => 'C:\\Users\\macbookpro\\Documents\\xampp\\htdocs\\prestashop123\\themes\\theme481\\authentication.tpl',
      1 => 1363052636,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '1706252ad57461d33d1-50858817',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_52ad57465afa23_42136325',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_52ad57465afa23_42136325')) {function content_52ad57465afa23_42136325($_smarty_tpl) {?><?php if (!is_callable('smarty_modifier_escape')) include 'C:\\Users\\macbookpro\\Documents\\xampp\\htdocs\\prestashop123\\tools\\smarty\\plugins\\modifier.escape.php';
?>
...
" method="post" id="new_account_form" class="std clearfix">
		<fieldset>
			<h1><?php echo smartyTranslate(array('s'=>'Instant Checkout'),$_smarty_tpl);?>
</h1>
 ...
 <sup>*</sup></label>
					<input type="email" class="email" id="guest_email" name="guest_email" value="<?php if (isset($_POST['guest_email'])){?><?php echo $_POST['guest_email'];?>
<?php }?>">
				</p>
...
&nbsp;&nbsp;</option>
				...
				<?php }?>
				<h1><?php echo smartyTranslate(array('s'=>'Delivery address'),$_smarty_tpl);?>
</h1>
...
<?php }?>" />
		...
		<p class="text">
			...
			<input type="url" class="text" id="website" name="website" value="<?php if (isset($_POST['website'])){?><?php echo $_POST['website'];?>
<?php }?>" />
		</p>
	</fieldset>
	<?php }?>
